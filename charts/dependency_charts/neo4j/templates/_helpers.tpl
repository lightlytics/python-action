...
{{/*
Added by Lightlytics
Returns the proper Service name depending if an explicit service name is set
in the values file. If the name is not explicitly set it will take the "neo4j.fullname"
*/}}
{{- define "neo4j.serviceName" -}}
 {{- if .Values.core.service.name -}}
   {{ .Values.core.service.name }}
 {{- else -}}
   {{ template "neo4j.fullname" .}}
 {{- end -}}
{{- end -}}