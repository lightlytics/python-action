...
def get_region_vpc_information(region):
    vpc_peering_json_file = 'devops-scripts/build_lightlytics/payload/staging_vpc_peering_mapping.json'
...
def create_region_network_loadbalancer(region, release):
    ...
    region_elbv2_boto_client = boto3.client("elbv2", region_name=region)
    vpc_peering_info = get_region_vpc_information(region)
