...
def get_msk():
    name, _ = get_resource_name_by_convention("kafka-cluster")
    kafka_cluster = msk.Cluster.get(
        name,
        id="arn:aws:kafka:us-east-1:624907860825:cluster/prod-lightlytics-kafka-cluster/7e532648-44ee-4b90-89e2-4c306f336149-8"
    )
